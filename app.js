...
description: "MVP LifeLine est conçu pour les rêveurs audacieux du monde. Une application IA puissante pour autonomiser les jeunes émotionnellement, financièrement et professionnellement."
},
es: {
...
description: "MVP LifeLine está hecho para los soñadores audaces del mundo. Una poderosa app de IA para empoderar a los jóvenes emocional, financiera y profesionalmente."
},
ar: {
...
get_started: "ابدأ",
description: "تم إنشاء MVP LifeLine للحالمين الجريئين عالميًا. تطبيق ذكاء اصطناعي قوي لتمكين الشباب عاطفياً ومالياً ومهنياً."
},
hi: {
...
description: "MVP LifeLine वैश्विक साहसी सपने देखने वालों के लिए बनाया गया है। यह युवाओं को भावनात्मक, आर्थिक और पेशेवर रूप से सशक्त करता है।"
},
zh: {
...
get_started: "开始",
description: "MVP LifeLine 是为全球有梦想的年轻人打造的强大 AI 应用，助力情感、财务和职业成长。"
},
pt: {
...
get_started: "Começar",
description: "O MVP LifeLine é feito para os sonhadores ousados do mundo. Um app de IA poderoso para capacitar os jovens emocional, financeira e profissionalmente."
},
ru: {
...
get_started: "Начать",
description: "MVP LifeLine создан для смелых мечтателей мира. Мощное AI-приложение для эмоционального, финансового и профессионального роста молодежи."
},
bn: {
...
description: "MVP LifeLine বিশ্বব্যাপী সাহসী স্বপ্নদর্শীদের জন্য নির্মিত। এটি একটি শক্তিশালী AI অ্যাপ যা তরুণদের মানসিক, আর্থিক ও পেশাগতভাবে ক্ষমতায়ন করে।"
},
pg: {
...
description: "MVP LifeLine na for Global youth wey get dream. This na strong AI app wey go help una mentally, financially and skill-wise."
}
};
